...
{
    [TestFixture]
    internal class WeightedDirectedGraphTest
    {
        ...
        public void Init()
        {
            adjMatrix = dataDir + "WDGraph_AdjMatrix.INP";
            edgeList = dataDir + "WDGraph_EdgeList.INP";
        }

        private void Expect(WeightedDirectedGraph g)
        {
            ...
            Assert.AreEqual(1, adjList[2].Count);
            ...
            Assert.AreEqual(4, edgeList.Last.Value.U);
            Assert.AreEqual(1, edgeList.Last.Value.V);
            Assert.AreEqual(10, edgeList.Last.Value.W);
        }
        ...
        {
            WeightedDirectedGraph g = new WeightedDirectedGraph(adjMatrix, SourceType.AdjMatrix);
            Expect(g);
        }
        ...
        {
            WeightedDirectedGraph g = new WeightedDirectedGraph(edgeList, SourceType.EdgeList);
            Expect(g);
        }
    }
}
